...
3.  [Analysis and Observations](#analysis-and-observations)
    * [Initial Capture Failure](#initial-capture-failure)
    * [Port Mirroring (SPAN) Configuration](#port-mirroring-span-configuration)
    * [Successful HTTP Traffic Capture](#successful-http-traffic-capture)
    * [Verification of SPAN Configuration](#verification-of-span-configuration)
    * [HTTP Traffic Analysis](#http-traffic-analysis)
    * [Importance of Capture Placement](#importance-of-capture-placement)
    * [Remote SPAN and Overhead](#remote-span-and-overhead)
    * [Why Capture Locally?](#why-capture-locally)
