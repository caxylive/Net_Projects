...
3.  [Analysis and Observations](#analysis-and-observations)
    * [Initial Capture Failure](#1-initial-capture-failure)
    * [Port Mirroring (SPAN) Configuration](#2-port-mirroring-span-configuration)
    * [Successful HTTP Traffic Capture](#3-successful-http-traffic-capture)
    * [Verification of SPAN Configuration](#4-verification-of-span-configuration)
    * [HTTP Traffic Analysis](#5-http-traffic-analysis)
    * [Importance of Capture Placement](#6-importance-of-capture-placement)
    * [Remote SPAN and Overhead](#7-remote-span-and-overhead)
    * [Why Capture Locally?](#8-why-capture-locally)
